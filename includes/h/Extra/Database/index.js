...
if (!fs.existsSync(process.cwd() + '/Maria_Database')) {
    ...
    fs.writeFileSync(process.cwd() + '/Maria_Database/A_README.md', 'This folder is used by FCA to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
